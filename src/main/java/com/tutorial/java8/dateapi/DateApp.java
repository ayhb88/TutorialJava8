package com.tutorial.java8.dateapi;
...
public class DateApp {
	...
	public void medirTiempo(int version) throws Exception {
		if (version == 7) {
	...
	public void periodoEntreFechas(int version) {
		if (version == 7) {
			...
			nacimiento.set(1988, 11, 15);
			actual.set(2023, 11, 7);
			...
			LocalDate nacimiento = LocalDate.of(1988, 12, 15);
	...
	public void convertir(int version) throws Exception {
		if(version == 7) {
